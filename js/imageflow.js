...
function ImageFlow ()
{
	...
	this.defaults =
	{
		aspectRatio:        10,          /* Aspect ratio of the ImageFlow container (width divided by height) */
		buttons:            false,          /* Toggle navigation buttons */
		captions:           false,           /*popis fotky Toggle captions */
		imageCursor:        'hand',      /* Cursor type for all images - default is 'default' */
		...
		imagesHeight:       1,           /* tvorba odrazu Height of the images div container in percent */
		imagesM:            0.7,            /* Multiplicator for all images in percent */
		onClick:            function() {Slimbox.open(this.url, this.title)},   /* Onclick behaviour */
		opacity:            false,          /* Toggle image opacity */
		opacityArray:       [10,8,6,4,2],   /* Image opacity (range: 0 to 10) first value is for the focussed image */
		percentLandscape:   38,            /* velikost fotky šíøka Scale landscape format */
		percentOther:       38,            /* velikost fotky výška Scale portrait and square format */
		...
		scrollbarP:         2.0,            /* Width of the scrollbar in percent */
		slider:             false,           /* linka Toggle slider */
		sliderCursor:       'e-resize',     /* Slider cursor type - default is 'default' */
		sliderWidth:        54,             /* Width of the slider in px */
		startID:            startID,              /* Glide to this image ID on startup */
		startAnimation:     true,          /* Animate images moving in from the right on startup */
		xStep:              20             /* posun pøi pøevinutí Step width on the x-axis in px */
	};
