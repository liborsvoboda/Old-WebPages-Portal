...
$.fn.jqPuzzle = function(settings, texts) {
	...
	var defaults = {
		...
		language: 'cs',				// language for gui elements [language code]
		...
		style: {
			...
			backgroundOpacity: 0.8	// opacity of the original image behind the pieces
	...
	var i18n = {
		...
		cs: {
			shuffleLabel: 			'Zamíchat',
			toggleOriginalLabel: 	'Original',
			toggleNumbersLabel: 	'Čísla',
			confirmShuffleMessage: 	'skutečně chcete hru zamýchat?',
			movesLabel:				'pohybů',
			secondsLabel:			'vteřin'
		},
		fr: {
...
//			var $credits = $('<a/>')
//				.text('jqPuzzle')
//				.attr('href', 'http://www.kliknetezde.cz/')
//				.css({
//					'float': 'right',
